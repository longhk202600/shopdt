<%-- 
    Document   : newjsp
    Created on : Jan 21, 2021, 10:58:33 AM
    Author     : Admin
--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 order-md-2 order-1"
                                ...
                                <div class="dropdown">
                                    ...
                                    <c:if test="${not empty sessionScope.lstProductincard}">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <c:if test="${type==0}">
                                                                ...
                                                                <c:if test="${type!=0}">
                                                                <li class="page-item"><a class="page-link" href="DisplayeachtypeSVL?pageIndex=${i}&type=${type}">${i}</a></li>
                                                                </c:if>
                                                            </c:otherwise>
                                                        </c:choose>
                                                    </c:forEach>
