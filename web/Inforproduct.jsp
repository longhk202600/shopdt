                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-xs-6 col-sm-6 col-md-3 col-lg-3 order-md-2 order-1"
                                ...
                                <div class="dropdown">
                                    ...
                                    <c:if test="${sessionScope.lstProductincard!=null && sessionScope.lstProductincard.size()!=0}">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 order-lg-1 order-0">
                            <div class="product-section product-section2" style="width: 63rem;">
                                <h2 class="title-product">
                                    <a href="#" class="title title2" >${product.productName}</a>
                                            ...
                                            <ul> 
                                                <li>
                                                    <div class="item-product">
                                                        <div class="thumb">
                                                            <a class="thu"><img class="reflection-grid-cell" src="${product.url}" alt="" style="width: 30rem" ></a>
                                                        </div>
                                                    </div>
                                                </li>
                                                        ...
                                                        <div class="thumb">
                                                            <table class="table">
                                                                <tr>
                                                                    ...
                                                                    <td></td>
                                                                    <td>${productdes.manhinh}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Camera sau:</th><td></td>
                                                                    <td>${productdes.camerasau}</td>
                                                                </tr> <tr>
                                                                    <th scope="row">Camera trước:</th><td></td>
                                                                    <td>${productdes.cameratruoc}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">CPU:</th>
                                                                    <td></td>
                                                                    <td>${productdes.cpu}</td>
                                                                </tr>
                                                                <tr><th scope="row">Ram:</th>
                                                                    <td></td>
                                                                    <td>${productdes.ram}</td>
                                                                </tr>
                                                                <tr><th scope="row">Bộ nhớ trong:</th>
                                                                    <td></td>
                                                                    <td>${productdes.bonhotrong}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Sim:</th>
                                                                    <td></td>
                                                                    <td>${productdes.sim}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Sản xuất tại:</th>
                                                                    <td></td>
                                                                    <td>${productdes.sanxuattai}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Hệ điều hành:</th>
                                                                    <td></td>
                                                                    <td>${productdes.heieuhanh}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Chống nước:</th>
                                                                    <td></td>
                                                                    <td>${productdes.chongnuoc}</td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="price">
                                                                <span class="price-current" ><fmt:formatNumber type = "number" pattern = "#,###.###" value = "${product.unitPrice}" />₫</span>
                                                            </div>
                                                            <a href="BuyProductSVL?productid=${product.productID}" class="view-more">Mua Ngay</a>
                                                            <a href="AddsessionCard?productid=${product.productID}" class="view-more"><button class="btn-danger" name="productid" value="${product.productID}">Thêm Vào Giỏ Hàng</button> </a>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <input type="text" name="usernameFB" id="usernameFB" class="form-control"
                                           <c:if test="${ac!=null}">value="${ac.getUsername()}" readonly </c:if> style="color: white">
                                </div>

                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                    <input type="email" name="emailFB" id="emailFB" class="form-control"
                                           <c:if test="${ac!=null}">value="${ac.getEmail()}" readonly </c:if> style="color: white">
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
